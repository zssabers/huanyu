...
register_shutdown_function(function() {
    ...
    include_once $XHPROF_ROOT . "/xhprof-master/xhprof_lib/utils/xhprof_lib.php";
    include_once $XHPROF_ROOT . "/xhprof-master/xhprof_lib/utils/xhprof_runs.php";
    ...
    echo "<script>console.log('{$run_id}')</script>";
});
