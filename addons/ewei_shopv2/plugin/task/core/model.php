...
class TaskModel extends PluginModel 
{
	...
	public function posterProgressMessage($openid, $record) 
	{
		...
		$message = array( "first" => array( "value" => (string) $record["niackname"] . "关注了您的海报，为您增加了1 点人气。", "color" => "#ff0000" ), "keyword2" => array( "title" => "处理进度", "value" => $record["tasktitle"], "color" => "#000000" ), "keyword3" => array( "title" => "处理内容", "value" => "海报任务", "color" => "#000000" ), "keyword1" => array( "title" => "业务类型", "value" => "会员通知", "color" => "#000000" ), "remark" => array( "value" => "当前进度：" . $record["task_progress"] . "/" . $record["task_demand"] . "\n扫描关注：" . $this_member["nickname"] . "\n扫描时间：" . date("Y-m-d H:i") . "如有疑问请联系在线客服", "color" => "#000000" ) );
