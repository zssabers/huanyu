...
{	
	public function get_waimai(){
		$res = pdo_get('cjdc_system', array('uniacid' => 9));
		$vip = pdo_get('cjdc_hyqx',array('id'=>5));
		app_json(array('res' => $res,'vip'=>$vip));;
	}
