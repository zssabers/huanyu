...
if($_GPC['op']=='dy'){
  ...
  message('打印成功！', $this->createWebUrl2('dlinydorder'), 'success');
}
...
if($_GPC['op']=='tg'){
  ...
  if($order['money']!=0 and ($order['pay_type']==1 || $order['pay_type']==2 || $order['pay_type']==5)){//金额大于零且微信支付
    if($order['pay_type']==1){
 ...
 ///////////////模板消息///////////////////
      ...
      message('拒绝成功',$this->createWebUrl2('dlinydorder',array()),'success');
}else{
