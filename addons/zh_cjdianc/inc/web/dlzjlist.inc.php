      ...
      foreach ($buffer as $k =>$row) {
        ...
        if($row['pay_type']==1){
         ...
         if($row['state']==9 or $row['state']==7){
          ...
          $row['sh_money']=number_format($row['money']+$row['yhq_money2']-(($list4['poundage']+$list4['tg_poundage'])/100*($row['money']+$row['yhq_money2']-$row['ps_money'])+$sys['ps_poundage']/100*$row['ps_money']),2);
