...
function ihttp_request($url, $post = '', $extra = array(), $timeout = 6) {
...
function ihttp_multi_request($urls, $posts = array(), $extra = array(), $timeout = 6) {
	if (!is_array($urls)) {
...
function ihttp_socketopen($hostname, $port = 80, &$errno, &$errstr, $timeout = 5) {
	$fp = '';
