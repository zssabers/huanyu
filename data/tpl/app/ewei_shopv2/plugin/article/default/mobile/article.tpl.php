...
<div class='fui-page  fui-page-current article-index-page'>
	...
	<div class='fui-content'>
		...
		<div class="fui-article-page">
			...
			<div class="fui-article-subtitle"><?php  echo $article['article_date_v'];?> <?php  if(!empty($article['article_mp'])) { ?><?php  if(!empty($article['article_author'])) { ?> 作者: <?php  echo $article['article_author'];?><?php  } ?> <a href="<?php  if(!empty($_W['shopset']['share']['followurl'])) { ?><?php  echo $_W['shopset']['share']['followurl'];?><?php  } else { ?>javascript:;<?php  } ?>"><?php  echo $article['article_mp'];?></a><?php  } ?>  </div>
			<!-- 关注提示 -->
