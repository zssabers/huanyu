<?php defined('IN_IA') or exit('Access Denied');?>
    ...
    <div class="copyright"><?php  if(empty($_W['setting']['copyright']['footerleft'])) { ?>Powered by <a href="https://www.qiyweb.com"><b>企越网络</b></a> v<?php echo IMS_VERSION;?> © 2014-2015 <a href="http://www.we7.cc">www.qiyweb.com</a><?php  } else { ?><?php  echo $_W['setting']['copyright']['footerleft'];?><?php  } ?></div>
    <?php  if(!empty($_W['setting']['copyright']['icp'])) { ?><div>备案号：<a href="https://www.qiyweb.com" target="_blank"><?php  echo $_W['setting']['copyright']['icp'];?></a></div><?php  } ?>
    </div>
