<?php defined('IN_IA') or exit('Access Denied');?><div class="region-goods-details row">
    ...
    <div class="region-goods-right col-sm-10">
        ...
        <div class="col-sm-4 col-xs-6">
            <?php echo tpl_form_field_dateranges('saletime', array('starttime'=>date('Y-m-d H:i', !empty($item['timestart'])?$item['timestart']:time()),'endtime'=>date('Y-m-d H:i', !empty($item['timeend'])?$item['timeend']:strtotime('7 days'))),true);?>
        </div>
        <?php  } else { ?>
