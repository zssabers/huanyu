    ...
    <div class="region-goods-right col-sm-10">
        ...
        <div class="col-sm-6 col-xs-6" style='padding-left:10px'>
            ...
            <div class="input-group" style="width: 50%;">
                <select class="form-control tpl-category-parent select2" id="dispatchid" name="merchid">
                    <option value="0">自营</option>
                    <?php  if(is_array($store)) { foreach($store as $store_item) { ?>
                    <option value="<?php  echo $store_item['id'];?>" <?php  if($item['merchid'] == $store_item['id']) { ?>selected="true"<?php  } ?>><?php  echo $store_item['merchname'];?></option>
                    <?php  } } ?>
                </select>
            </div>
			<?php  } ?>
