...
<div class="page-content">
    ...
    <form <?php if( mce('shop.adv' ,$item) ) { ?>action="" method="post"<?php  } ?> class="form-horizontal form-validate" enctype="multipart/form-data">
    <input type="hidden" name="id" value="<?php  echo $item['id'];?>"/>
    <div class="form-group">
        <label class="col-lg control-label">排序</label>
        <div class="col-sm-9 col-xs-12">
            <?php if( mce('shop.adv' ,$item) ) { ?>
        ...
        <div class="col-sm-9 col-xs-12">
            ...
            <div class="input-group form-group" style="margin: 0;">
                ...
                <span class="input-group-btn">
                        <span data-input="#advlink" data-toggle="selectUrlMerch" class="btn btn-default">选择链接</span>
                    </span>
            </div>
            <?php  } else { ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9 col-xs-12">
            ...
            <?php  } ?>
            <input type="button" name="back" onclick='history.back()' <?php if(mcv('shop.adv.add|shop.adv.edit')) { ?>style='margin-left:10px;'<?php  } ?> value="返回列表" class="btn btn-default" />
        </div>
    </div>
    </form>
</div>
