...
<div class="nav_box col-md-1">
    ...
    <!--     <span class="ygxian"></span>
        ...
        <li class="active"><a href="<?php  echo $this->createWebUrl2('dlincoupons')?>">优惠券列表</a></li>
        <li><a href="<?php  echo $this->createWebUrl2('dlinaddcoupons')?>">添加/编辑优惠券</a></li>
    </ul>
</div>
...
<!-- <ul class="nav nav-tabs">
    <span class="ygxian"></span>
    <div class="ygdangq">当前位置:</div> 
    <li class="active"><a href="<?php  echo $this->createWebUrl2('dlincoupons')?>">优惠券管理</a></li>
    <li><a href="<?php  echo $this->createWebUrl2('dlinaddcoupons')?>">添加/编辑优惠券</a></li>
</ul> -->
<div class="main">
            ...
            <div class="row">
                <table class="yg5_tabel col-md-12">
                  ...
                  <?php  } else if($item['type']==3) { ?>
                   ...
                   <?php  } ?>
                    <td>
                        <a href="<?php  echo $this->createWebUrl2('dlinaddcoupons', array('id' => $item['id']))?>" class="storespan btn btn-xs">
                        ...
                        <!-- <a class="btn btn-warning btn-sm" href="<?php  echo $this->createWebUrl2('dladdcoupons', array('id' => $item['id']))?>" title="编辑">改</a>&nbsp;&nbsp;
                     ...
                     <div class="modal fade" id="myModal<?php  echo $item['id'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                      <div class="modal-dialog" role="document">
                        ...
                        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                            <a href="<?php  echo $this->createWebUrl2('dlincoupons', array('op' => 'delete', 'id' => $item['id']))?>" type="button" class="btn btn-info" >确定</a>
                        </div>
                    </div>
                </div>
            </div>
