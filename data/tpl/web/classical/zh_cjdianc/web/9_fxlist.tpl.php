...
<ul class="nav nav-tabs">
                  ...
                  <table class="yg5_tabel col-md-12 table table-bordered">
                        ...
                        <tr class="yg5_tr2">
                         ...
                         <td><?php  echo $item['sj'];?></td>
						  ...
						  <?php  if($item['tgy']==1) { ?>
						  <a class="team myModalc<?php  echo $item['user_id'];?>" href="javascript:void(0);" data-toggle="modal" data-target="#myModalb">店铺：<?php  echo $item['storenum'];?></a>
						   <script type="text/javascript">
                             $(function(){
                                    $(".myModalc<?php  echo $item['user_id'];?>").each(function(index){
                                        $(this).click(function(){            
                                            id = <?php  echo $item['user_id'];?>;
                                            $.ajax({
                                                type:"post",
                                                url:"<?php  echo $_W['siteroot'];?>/app/index.php?i=<?php  echo $_W['uniacid'];?>&c=entry&do=GetDp&m=zh_cjdianc",
                                                dataType:"json",
                                                data:{user_id:id},
                                                success:function(data){
                                                    console.log(data);
                                                    ...
                                                    for(var i=0;i<con.length;i++){
                                                      $(".xiaxian tbody").append('<tr><td>'+i+'</td><td>'+con[i].fx_name+'</td><td>店铺</td><td>'+con[i].storename+'</td><td>'+con[i].sq_time+'</td></tr>')
                                                    }  
                                                  }
                                                }
                                            })
                        ...
                        <td >
							...
							<?php  if($item['tgy']==1) { ?>
							<span class="label storered">推广员</span>
							<?php  } else if($item['tgy']==0) { ?>
							<span class="label storered">分销员</span>
							<?php  } ?>
                        </td>
                          ...
                          <?php  } ?>
                             ...
                             <td class="caozuo">     
                                ...
                                <ul class="caozuo_select">
                                 ...
                                 <li><a href="javascript:;"  data-toggle="modal" data-target="#myModal<?php  echo $item['id'];?>">充值金额</a></li>
								 <?php  if($item['tgy']==1) { ?>
								 <li><a href="javascript:;"  data-toggle="modal" data-target="#myModals<?php  echo $item['id'];?>">更改店铺名额</a></li>
								 <?php  } ?>
								 <?php  if($item['tgy']==0) { ?>
								 <li><a href="<?php  echo $this->createWebUrl('fxlist',array('id'=>$item['id'],'op'=>'tgy'));?>" onclick="return confirm('确认升级推广员吗？');return false;">成为推广员</a></li>
                                   <?php  } ?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
	 ...
	 <div class="modal fade" id="myModals<?php  echo $item['id'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
      ...
      <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data">
        <div class="modal-body">
          ...
          <div class="qs_box col-md-12 pa_0">
            <label for="" class="col-md-3">更改店铺名额 :</label>
            <input type="text" value="<?php  echo $item['store_num'];?>" name="store_num" class="col-md-6 con">
          </div>          
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">取消
          </button>
          <input type="submit" class="btn btn-primary" value="确定" name="submits">
        </div>
        <input type="hidden" name="user_id" value="<?php  echo $item['user_id'];?>"/>
        <input type="hidden" name="token" value="<?php  echo $_W['token'];?>"/>
      </form>
