...
<ul class="nav nav-tabs">
    ...
    <li <?php  if($type=='wm') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('userorder',array('type'=>wm,'user_id'=>$_GPC['user_id']));?>">外卖订单</a></li>
    <li <?php  if($type=='dn') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('userorder',array('type'=>dn,'user_id'=>$_GPC['user_id']));?>">店内订单</a></li>
    <li <?php  if($type=='yy') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('userorder',array('type'=>yy,'user_id'=>$_GPC['user_id']));?>">预约订单</a></li>
    <li <?php  if($type=='dm') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('userorder',array('type'=>dm,'user_id'=>$_GPC['user_id']));?>">当面付订单</a></li>
