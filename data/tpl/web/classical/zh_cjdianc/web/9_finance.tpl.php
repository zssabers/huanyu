...
<div class="ygrow reset">
    <div class="reset_box">
        <font color="red">数据清空功能说明：当你中途准备修改商家提成比例时，需在修改之前跟商家结清余额，然后在修改比例，此时商家余额会变得不正常，点击数据清零按钮即可恢复正常</font>
    </div>

</div>
<div class="ygrow reset">
    <div class="reset_box">
        <div class="reset_tip">可提现余额<b><?php  echo $ktxcost;?></b><span>元</span><a href="javascript:;" class="btn btn-default reset_btn" data-toggle="modal" data-target="#myModal">申请提现</a><a href="javascript:;" class="btn btn-default reset_btn" data-toggle="modal" data-target="#myModaljd">数据清零</a></div>
...
<div class="modal fade" id="myModaljd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                      <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-body" style="font-size: 20px">
                            请先认真阅读清零功能说明,在选择确认清零!
                        </div>
                        <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                            <a href="<?php  echo $this->createWebUrl('finance',array('op'=>'zeroing','money'=>$ktxcost));?>" type="button" class="btn btn-info" >确定</a>
                        </div>
                    </div>
                </div>
            </div>
