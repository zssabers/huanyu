...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="<?php  echo $this->createWebUrl2('dlpsmoney')?>">配送费管理</a></li>
    <li><a href="<?php  echo $this->createWebUrl2('dladdpsmoney')?>">添加/编辑配送费</a></li>
</ul>
<div class="main">
        ...
        <div class="panel-body" style="padding: 0px 15px;">
            <div class="row">
                <table class="yg5_tabel col-md-12">
                    ...
                    <td>
                        <a href="<?php  echo $this->createWebUrl2('dladdpsmoney', array('id' => $row['id']))?>" class="storespan btn btn-xs">
                    ...
                    <div class="modal fade" id="myModal<?php  echo $row['id'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                      <div class="modal-dialog" role="document">
                        ...
                        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                            <a href="<?php  echo $this->createWebUrl2('dlpsmoney', array('op' => 'delete', 'id' => $row['id']))?>" type="button" class="btn btn-info" >确定</a>
                        </div>
                    </div>
                </div>
            </div>
