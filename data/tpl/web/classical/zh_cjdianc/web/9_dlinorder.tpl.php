...
<!--     <li <?php  if($type=='dd') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl2('dlinorder',array('type'=>dd));?>">预约到店</a></li> -->
    <li <?php  if($type=='cancel') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl2('dlinorder',array('type'=>cancel));?>">取消/拒绝/退款</a></li> 
...
<div class="row ygrow">
    <div class="col-lg-11 nav_head">
        ...
        <ul class="nav nav-tabs data_tip col-md-4" style="float: left;margin:0">
         <li<?php  if($type2=='yesterday') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl2('dlinorder',array('type2'=>yesterday,'type'=>$type));?>">昨天</a></li>
            <li<?php  if($type2=='today') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl2('dlinorder',array('type2'=>today,'type'=>$type));?>">今天</a></li>
            <li<?php  if($type2=='week') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl2('dlinorder',array('type2'=>week,'type'=>$type));?>">近七天</a></li>
            <li<?php  if($type2=='month') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl2('dlinorder',array('type2'=>month,'type'=>$type));?>">本月</a></li>
        </ul>        
            ...
            <div class="panel-body" style="padding: 0px 15px;">
                ...
                <?php  if($item['order']['state']==1 || $item['order']['state']==6) { ?>
                    ...
                    <div class="col-md-12 orderback">
                        ...
                        <div class="left">
                            <span class="orfont1 orfont8">#<?php  if($item['order']['oid']) { ?><?php  echo $item['order']['oid'];?><?php  } else { ?><?php  echo $item['order']['id'];?><?php  } ?><font color="#07BD13">（ID：<?php  echo $item['order']['id'];?>）</font></span>
                            <span>
                            ...
                            <a href="<?php  echo $this->createWebUrl2('dlinorder',array('op'=>'dy','order_id'=>$item['order']['id']));?>"><span class="btn btn-xs orderbtn">打印小票</span></a>
                        </div>
                        <div class="right">
                        <?php  if($item['order']['state']==1) { ?>
                            <div class="left orderconfirm2">待支付</div>
                               <a data-toggle="modal" data-target="#myModalsc<?php  echo $item['order']['id'];?>" href="javascript:void(0);"><div class="left orderconfirm">删除订单</div></a>
                        <?php  } else if($item['order']['state']==2) { ?>
                            <div class="left orderconfirm2">待接单</div>
                            <a data-toggle="modal" data-target="#myModaljd<?php  echo $item['order']['id'];?>" href="javascript:void(0);"><div class="left orderconfirm">点击接单</div></a>
                            <a data-toggle="modal" data-target="#myModal<?php  echo $item['order']['id'];?>" href="javascript:void(0);"><div class="left orderconfirm">拒接接单</div></a>
                        <?php  } else if($item['order']['state']==3) { ?>
                            ...
                            <div class="left orderconfirm2 ps_info" id="order_info" value="<?php  echo $item['order']['id'];?>">
                             ...
                             <a data-toggle="modal" data-target="#myModalwc<?php  echo $item['order']['id'];?>" href="javascript:void(0);"><div class="left orderconfirm">点击完成</div></a> 
                             <a data-toggle="modal" data-target="#myModalqx<?php  echo $item['order']['id'];?>" href="javascript:void(0);"><div class="left orderconfirm">取消订单</div></a>
                        ...
                        <?php  } else if($item['order']['state']==8) { ?>
                            ...
                            <a data-toggle="modal" data-target="#myModaltk<?php  echo $item['order']['id'];?>" href="javascript:void(0);"><div class="left orderconfirm">通过退款</div></a>
                            <a data-toggle="modal" data-target="#myModaltkjj<?php  echo $item['order']['id'];?>" href="javascript:void(0);"><div class="left orderconfirm">拒绝退款</div></a>
...
<div class="modal fade" id="myModalsc<?php  echo $item['order']['id'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                      <div class="modal-dialog" role="document">
                        ...
                        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                            <a href="<?php  echo $this->createWebUrl2('dlinorder',array('op'=>'delete','id'=>$item['order']['id']));?>" type="button" class="btn btn-info" >确定</a>
                        </div>
                    </div>
                </div>
            </div>

            <div class="modal fade" id="myModal<?php  echo $item['order']['id'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        ...
                        <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                            <a href="<?php  echo $this->createWebUrl2('dlinorder',array('op'=>'jjjd','id'=>$item['order']['id']));?>" type="button" class="btn btn-info" >确定</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal fade" id="myModaljd<?php  echo $item['order']['id'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        ...
                        <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                            <a href="<?php  echo $this->createWebUrl2('dlinorder',array('op'=>'jd','id'=>$item['order']['id']));?>" type="button" class="btn btn-info" >确定</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal fade" id="myModalwc<?php  echo $item['order']['id'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        ...
                        <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                            <a href="<?php  echo $this->createWebUrl2('dlinorder',array('op'=>'wc','id'=>$item['order']['id']));?>" type="button" class="btn btn-info" >确定</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal fade" id="myModalqx<?php  echo $item['order']['id'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        ...
                        <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                            <a href="<?php  echo $this->createWebUrl2('dlinorder',array('op'=>'cancel','id'=>$item['order']['id']));?>" type="button" class="btn btn-info" >确定</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal fade" id="myModaltk<?php  echo $item['order']['id'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        ...
                        <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                            <a href="<?php  echo $this->createWebUrl2('dlinorder',array('op'=>'refund','id'=>$item['order']['id']));?>" type="button" class="btn btn-info" >确定</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal fade" id="myModaltkjj<?php  echo $item['order']['id'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        ...
                        <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                            <a href="<?php  echo $this->createWebUrl2('dlinorder',array('op'=>'reject','id'=>$item['order']['id']));?>" type="button" class="btn btn-info" >确定</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12 orderback2">
                        <div class="ordername">
                         ...
                         <?php  echo $item['order']['userName'];?>（用户ID：<?php  echo $item['order']['user_id'];?>）
                        <div class="">
                    ...
                    <div class="col-md-12 orderback2">
						...
						<p><span class="orbeizhu">餐具：</span> × <?php  echo $item['order']['tableware'];?> 份</p>
                    </div>
                    <div class="col-md-12 orderback2">
                    ...
                    <div class="col-md-12 orderback2">
                        ...
                        <div class="orderaccount">
                            ...
                            <div class="orderbox2 left"><?php  if($item['order']['pay_type']==1) { ?>微信支付<?php  } else if($item['order']['pay_type']==2) { ?>余额支付<?php  } else if($item['order']['pay_type']==3) { ?>积分支付<?php  } else if($item['order']['pay_type']==5) { ?>储值卡支付<?php  } else { ?>货到付款<?php  } ?></div>
                        </div>
                    </div>
                    <div class="col-md-12 orderback2">
                       <!-- <div class="orderaccount orfont7">
                            <div class="orderbox1 left">本单预计收入</div>
                            <?php  if($item['order']['is_poundage']==1) { ?>
                            <div class="orderbox2 left">¥<?php  echo number_format($item['order']['money']+$item['order']['yhq_money2']-($item['order']['poundage']/100*($item['order']['money']+$item['order']['yhq_money2']-$item['order']['ps_money']))-$item['order']['ps_money']*$item['order']['ps_poundage']/100,2)?></div>
                            <?php  } else { ?>
                         ...
                         <?php  if($item['order']['state']==1) { ?>
                            <div class="font1">本单顾客实际支付：¥
                                <input style="border:0" type="text" name="money" data-id="<?php  echo $item['order']['id'];?>" data-money="<?php  echo $item['order']['money'];?>" value="<?php  echo $item['order']['money'];?>"><?php  if($item['order']['yhq_money2']>0) { ?>(平台优惠:<?php  echo $item['order']['yhq_money2'];?>)<?php  } ?>
                            </div>
                            <?php  } else { ?>
                            <div class="font1">本单顾客实际支付：¥
                               <?php  echo $item['order']['money'];?><?php  if($item['order']['yhq_money2']>0) { ?>(平台优惠:<?php  echo $item['order']['yhq_money2'];?>)<?php  } ?>
                            </div>
                            <?php  } ?>
                    ...
                    <div class="col-md-12 orderback3">
                        下单数：<?php  if($item['order']['order_nums']==1) { ?><font color="#48D27A">首次下单</font><?php  } else { ?>第<font color="#48D27A"><?php  echo $item['order']['order_nums'];?></font>次下单<?php  } ?>
...
<input id="dsd" type="number" value="0" style="display:none"/>
   ...
   function dsddd(){
		   var conut = $("#dsd").val();
			$.ajax({ 
				type: "post",
				dataType: "json",
				url: "<?php  echo $_W['siteroot'];?>/app/index.php?i=<?php  echo $_W['uniacid'];?>&c=entry&do=newdsd&m=zh_cjdianc&store=<?php  echo $_COOKIE['storeid'];?>",
				success: function (data) {
					 if(data>conut){
					 $("#dsd").val(data);
					 var myAuto5 = document.getElementById('myaudio5');
    ...
    $("input[name='money']").change(function () {
            ...
            let y_money =$(this).attr("data-money")
            $.ajax({
                type:"post",
