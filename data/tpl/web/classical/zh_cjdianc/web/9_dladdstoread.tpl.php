...
<ul class="nav nav-tabs">
    ...
    <li><a href="<?php  echo $this->createWebUrl2('dlstoread')?>">商家轮播图列表</a></li>
    <li class="active"><a href="<?php  echo $this->createWebUrl2('dladdstoread')?>">添加商家轮播图</a></li>
</ul>
<div class="main">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
						...
						<div class="ygmargin">轮播图建议： 702*300</div>
                    </div>
                </div>
                <div class="form-group">
