...
<div class="ygrow reset">
    <div class="reset_box">
        <div class="reset_tip">充值金额<b><?php  if($cz['money']) { ?><?php  echo $cz['money'];?><?php  } else { ?>0.00<?php  } ?></b><span>元</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 赠送金额<b><?php  if($zs['money2']) { ?><?php  echo $zs['money2'];?><?php  } else { ?>0.00<?php  } ?></b><span>元</span></div>
    </div>
