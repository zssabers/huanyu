...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="<?php  echo $this->createWebUrl2('dlaccount')?>">子账号管理</a></li>
    <li><a href="<?php  echo $this->createWebUrl2('dladdaccount')?>">添加/子编辑账号</a></li>
</ul>
<div class="main">
<!--     <div class="panel panel-default ygbody">
        <div class="panel-body">
            <p class="yangshi">餐饮后台登陆地址:&nbsp;&nbsp;<a href="<?php  echo $_W['siteroot'];?>web/zhjd.php?c=user&a=login" target="_blank"><?php  echo $_W['siteroot'];?>web/zhjd.php?c=user&a=login</a></p>
        </div>
    </div> -->
                ...
                <table class="yg5_tabel col-md-12">
                    ...
                    <tr class="yg5_tr2">
                      ...
                      <?php  } else if($item['status']==1) { ?>
                       ...
                       <?php  } ?>
                        <td>
                            <a href="<?php  echo $this->createWebUrl2('dladdaccount', array('id' => $item['id']))?>" class="storespan btn btn-xs">
                    ...
                    <div class="modal fade" id="myModal<?php  echo $item['id'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                      <div class="modal-dialog" role="document">
                        ...
                        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                            <a href="<?php  echo $this->createWebUrl2('dlaccount', array('op' => 'delete', 'id' => $item['id']))?>" type="button" class="btn btn-info" >确定</a>
                        </div>
                    </div>
                </div>
            </div>
