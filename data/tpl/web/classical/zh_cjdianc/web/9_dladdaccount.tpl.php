...
<ul class="nav nav-tabs">
    ...
    <li><a href="<?php  echo $this->createWebUrl2('dlaccount')?>">子账号管理</a></li>

    <li class="active"><a href="<?php  echo $this->createWebUrl2('dladdaccount')?>">添加/编辑子账号</a></li>
...
<div class="main">
    ...
    <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data">
        ...
        <div class="panel panel-default ygdefault">
            ...
            <div class="panel-heading wyheader"> 添加/编辑子账号</div>
            ...
            <div class="panel-body panel">
                ...
                <div class="form-group">
                    ...
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">状态<?php  echo $ccount['authority'];?></label>
