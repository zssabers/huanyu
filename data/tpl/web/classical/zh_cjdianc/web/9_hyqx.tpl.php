...
<ul class="nav nav-tabs">    
    <li class="active"><a href="<?php  echo $this->createWebUrl('hyqx')?>">会员期限</a></li>
    <li><a href="<?php  echo $this->createWebUrl('addhyqx')?>">添加会员期限</a></li>
</ul>
<div class="main">
    <!-- 门店列表部分开始 -->
                ...
                <div class="row">
                    <table class="yg5_tabel col-md-12">
                        ...
                        <tr class="yg5_tr2">
                            ...
                            <td>
                             <a href="<?php  echo $this->createWebUrl('addhyqx', array('id' => $row['id']))?>" class="storespan btn btn-xs">
                      ...
                      <div class="modal-dialog" role="document">
                        ...
                        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                            ...
                            <a href="<?php  echo $this->createWebUrl('hyqx', array('id' => $row['id']))?>" type="button" class="btn btn-info" >确定</a>
