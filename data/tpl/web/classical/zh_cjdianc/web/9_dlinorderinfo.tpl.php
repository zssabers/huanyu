...
<div class="main ygmain">
    <div class="panel panel-default">
        <div class="panel-body">
            <a class="btn label-orderinfo" href="<?php  echo $this->createWebUrl2('dlinorder');?>"><i class="fa fa-refresh"></i>返回订单管理</a>
        </div>
    </div>
    <div class="panel panel-default">
    ...
    <div class="col-md-12">
                    <?php  if($item['state']==2) { ?>
                  <a href="<?php  echo $this->createWebUrl2('dlinorder',array('op'=>'jd','id'=>$item['id']));?>"><button class="btn btn-sm btn-warning">点击接单</button></a>
                  <?php  } ?>
                   <?php  if($item['state']==8) { ?>
                  <a href="<?php  echo $this->createWebUrl2('dlinorder',array('op'=>'refund','id'=>$item['id']));?>"><button class="btn btn-sm btn-info">通过退款</button></a>
                  <a href="<?php  echo $this->createWebUrl2('dlinorder',array('op'=>'reject','id'=>$item['id']));?>"><button class="btn btn-sm btn-warning">拒绝退款</button></a>
                  <?php  } ?>
