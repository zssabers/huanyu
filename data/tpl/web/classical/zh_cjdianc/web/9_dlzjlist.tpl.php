...
<ul class="nav nav-tabs" style="float: left;margin-bottom: 20px;">
    ...
    <li<?php  if($type=='yesterday') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl2('dlzjlist',array('type'=>yesterday));?>">昨天</a></li>
    <li<?php  if($type=='today') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl2('dlzjlist',array('type'=>today));?>">今天</a></li>
    <li<?php  if($type=='week') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl2('dlzjlist',array('type'=>week));?>">近七天</a></li>
    <li<?php  if($type=='month') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl2('dlzjlist',array('type'=>month));?>">本月</a></li>
</ul>
<div class="row ygrow" style="float: left;margin-top: 30px;">
    <div class="col-lg-12">
        <form action="" method="get" class="col-md-4">
                   ...
                   <input type="hidden" name="do" value="dlzjlist" />
...
<table class="table table-striped table_list">
    <tr>
        <td>
            <p>商户实收</p>
            <span>¥<?php  echo number_format($list2['total_money']-$list3['tk_money']-$list3['hb_money']-$item['ptps_money']-$fw_money-$list6['commission']-$list7['yycommission']-$list8['fwycommission'],2)?></span>
        </td>
        <td>
            <p class="fuhao">=</p>
        </td>
        ...
        <td>
            <p>优惠金额</p>
            <span>¥<?php  if($yh_money) { ?><?php  echo $yh_money;?><?php  } else { ?>0.00<?php  } ?></span>
        </td>
        <td>
            <p class="fuhao">－</p>
        </td>
 ...
 <div class="main">
   ...
   <!--                          <input type="checkbox" class="allcheck" />
                    ...
                    <tr class="yg5_tr2">
                        ...
                        <td>  <span class="label storewarning">储值卡支付</span></td>
                        <?php  } ?>
                       ...
                       <?php  echo number_format($item['money']-$item['commission']-$item['yycommission']-$item['fwycommission']-$item['ptps_money']-($sys['ps_poundage']/100*$item['ps_money']),2)?>
                        ...
                        <td class="col-md-1 cainame<?php  echo $item['id'];?>">
						   <?php  echo number_format(($sys['ps_poundage']/100*$item['ps_money']+$item['ptps_money']),2)?>
						</td>
                        <?php  } ?>
