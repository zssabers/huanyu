...
<ul class="nav nav-tabs" style="float: left;margin-bottom: 20px;">
    ...
    <li<?php  if($type=='yesterday') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl2('dldmzjlist',array('type'=>yesterday));?>">昨天</a></li>
    <li<?php  if($type=='today') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl2('dldmzjlist',array('type'=>today));?>">今天</a></li>
    <li<?php  if($type=='week') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl2('dldmzjlist',array('type'=>week));?>">近七天</a></li>
    <li<?php  if($type=='month') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl2('dldmzjlist',array('type'=>month));?>">本月</a></li>
</ul>
<div class="row ygrow" style="float: left;margin-top: 30px;">
    <div class="col-lg-12">
        <form action="" method="get" class="col-md-4">
                   ...
                   <input type="hidden" name="do" value="dldmzjlist" />
   ...
   <!--                          <input type="checkbox" class="allcheck" />
                    ...
                    <tr class="yg5_tr2">
                      ...
                      0.00                        
                           ...
                           <td class="col-md-1 cainame<?php  echo $item['id'];?>">
                      <!--<?php  echo number_format((($list4['dm_poundage']+$list4['tg_dmpoundage'])/100*$item['money']),2)?> -->   
						0.00					  
                        </td>
