...
<ul class="nav nav-tabs">
	...
	<li ><a href="<?php  echo $this->createWebUrl('reservation')?>">预定时间</a></li>
	<li class="active"><a href="<?php  echo $this->createWebUrl('addreservation',array('op'=>'post'))?>">添加预定开放时间段</a></li>
