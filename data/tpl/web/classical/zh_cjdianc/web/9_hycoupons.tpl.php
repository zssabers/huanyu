...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="<?php  echo $this->createWebUrl('hycoupons')?>">红包管理</a></li>
    <li><a href="<?php  echo $this->createWebUrl('hyaddcoupons')?>">添加/编辑红包</a></li>
</ul>
<div class="main">
        ...
        <div class="panel-body" style="padding: 0px 15px;">
            <div class="row">
                <table class="yg5_tabel col-md-12">
                    ...
                    <td>
                        <a href="<?php  echo $this->createWebUrl('hyaddcoupons', array('id' => $item['id']))?>" class="storespan btn btn-xs">
                        ...
                        <!-- <a class="btn btn-warning btn-sm" href="<?php  echo $this->createWebUrl('hyaddcoupons', array('id' => $item['id']))?>" title="编辑">改</a>&nbsp;&nbsp;
                     ...
                     <div class="modal fade" id="myModal<?php  echo $item['id'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                      <div class="modal-dialog" role="document">
                        ...
                        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                            <a href="<?php  echo $this->createWebUrl('hycoupons', array('op' => 'delete', 'id' => $item['id']))?>" type="button" class="btn btn-info" >确定</a>
                        </div>
                    </div>
                </div>
            </div>
