...
<div class="row ygrow">
  <div class="col-lg-11 nav_head">
    ...
    <form action="" method="POST" class="" style="margin-left:20px;">
      <div class="">
          ...
          <div class="row" style="position: relative;">
            ...
            <div class="col-md-12 orderback2">
              ...
              <div class="orderaccount">
                ...
                <div class="orderbox2 left"><?php  if($item['order']['pay_type']==1) { ?>微信支付<?php  } else if($item['order']['pay_type']==2) { ?>余额支付<?php  } else if($item['order']['pay_type']==3) { ?>积分支付<?php  } else if($item['order']['pay_type']==5) { ?>储值卡支付<?php  } else { ?>餐后支付<?php  } ?></div>
              </div>
            </div>
            <div class="col-md-12 orderback2">
