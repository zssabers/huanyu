  ...
  <div class="col-lg-11 nav_head">
    <form action="" method="get" class="col-md-4" style="padding-left: 0">
      ...
      <input type="hidden" name="token" value="<?php  echo $_W['token'];?>"/>
         ...
         <li<?php  if($type2=='yesterday') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('dnorder',array('type2'=>yesterday,'type'=>$type));?>">昨天</a></li>
            <li<?php  if($type2=='today') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('dnorder',array('type2'=>today,'type'=>$type));?>">今天</a></li>
            <li<?php  if($type2=='week') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('dnorder',array('type2'=>week,'type'=>$type));?>">近七天</a></li>
            <li<?php  if($type2=='month') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('dnorder',array('type2'=>month,'type'=>$type));?>">本月</a></li>
        </ul>      
          ...
          <div class="row" style="position: relative;">
            ...
            <div class="col-md-12 orderback">
              <div class="left">
                ...
                <a href="<?php  echo $this->createWebUrl('dnorder',array('op'=>'dy','order_id'=>$item['order']['id']));?>"> <button class="btn btn-xs orderbtn">打印小票</button></a>
              </div>
            ...
            <div class="col-md-12 orderback2">
              ...
              <div class="orderaccount">
                ...
                <div class="orderbox2 left"><?php  if($item['order']['pay_type']==1) { ?>微信支付<?php  } else if($item['order']['pay_type']==2) { ?>余额支付<?php  } else if($item['order']['pay_type']==3) { ?>积分支付<?php  } else { ?>餐后支付<?php  } ?></div>
              </div>
            </div>
            <div class="col-md-12 orderback2">
