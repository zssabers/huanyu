...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="<?php  echo $this->createWebUrl2('dlprintlabel')?>">标签管理</a></li>
    <li><a href="<?php  echo $this->createWebUrl2('dladdprintlabel')?>">添加标签</a></li>
</ul>
<div class="main">
        ...
        <div class="panel-body" style="padding: 0px 15px;">
            <div class="row">
                <table class="yg5_tabel col-md-12">
                    <tr class="yg5_tr1">
                        <th class="col-md-2 store_td1">排序</th>
                    ...
                    <tr class="yg5_tr2">
                        ...
                        <td>
                            <a href="<?php  echo $this->createWebUrl2('dladdprintlabel', array('id' => $row['id']))?>" class="storespan btn btn-xs">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                                        <a href="<?php  echo $this->createWebUrl2('dlprintlabel', array('op' => 'delete', 'id' => $row['id']))?>" type="button" class="btn btn-info" >确定</a>
                                </div>
                            </div>
                        </div>
                    </div>
