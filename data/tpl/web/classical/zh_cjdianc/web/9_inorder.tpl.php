...
<?php  if(is_array($data3)) { foreach($data3 as $key => $item) { ?>
 ...
 <!--                            <span class="orfont1 orfont8">#<?php  if($item['order']['oid']) { ?><?php  echo $item['order']['oid'];?><?php  } else { ?><?php  echo $item['order']['id'];?><?php  } ?></span> -->
                            <span>
                            ...
                            <a href="<?php  echo $this->createWebUrl('inorder',array('op'=>'dy','order_id'=>$item['order']['id']));?>"><span class="btn btn-xs orderbtn">打印小票</span></a>
                        </div>
                        <div class="right">
    ...
    <!--                         <a data-toggle="modal" data-target="#myModalwc<?php  echo $item['order']['id'];?>" href="javascript:void(0);"><div class="left orderconfirm">点击完成</div></a> -->
            ...
            <div class="modal fade" id="myModalsc<?php  echo $item['order']['id'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                      <div class="modal-dialog" role="document">
                        ...
                        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                            <a href="<?php  echo $this->createWebUrl('inorder',array('op'=>'delete','id'=>$item['order']['id']));?>" type="button" class="btn btn-info" >确定</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal fade" id="myModal<?php  echo $item['order']['id'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                      <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                            <a href="<?php  echo $this->createWebUrl('inorder',array('op'=>'jjjd','id'=>$item['order']['id']));?>" type="button" class="btn btn-info" >确定</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal fade" id="myModaljd<?php  echo $item['order']['id'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                      <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                            <a href="<?php  echo $this->createWebUrl('inorder',array('op'=>'jd','id'=>$item['order']['id']));?>" type="button" class="btn btn-info" >确定</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal fade" id="myModalwc<?php  echo $item['order']['id'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                      <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                            <a href="<?php  echo $this->createWebUrl('inorder',array('op'=>'wc','id'=>$item['order']['id']));?>" type="button" class="btn btn-info" >确定</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal fade" id="myModalqx<?php  echo $item['order']['id'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                      <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                            <a href="<?php  echo $this->createWebUrl('inorder',array('op'=>'cancel','id'=>$item['order']['id']));?>" type="button" class="btn btn-info" >确定</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal fade" id="myModaltk<?php  echo $item['order']['id'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                      <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                            <a href="<?php  echo $this->createWebUrl('inorder',array('op'=>'refund','id'=>$item['order']['id']));?>" type="button" class="btn btn-info" >确定</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal fade" id="myModaltkjj<?php  echo $item['order']['id'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                      <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                            <a href="<?php  echo $this->createWebUrl('inorder',array('op'=>'reject','id'=>$item['order']['id']));?>" type="button" class="btn btn-info" >确定</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12 orderback2">
                        ...
                        <div class="orderaccount">
                            ...
                            <div class="orderbox2 left"><?php  if($item['order']['pay_type']==1) { ?>微信支付<?php  } else if($item['order']['pay_type']==2) { ?>余额支付<?php  } else if($item['order']['pay_type']==3) { ?>积分支付{else $item['order']['pay_type']==5}储值卡支付<?php  } else { ?>货到付款<?php  } ?></div>
                        </div>
                    </div>
                    <div class="col-md-12 orderback2">
