...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="<?php  echo $this->createWebUrl2('dlreservation')?>">预定时间</a></li>
            ...
            <div class="row">              
              ...
              <tr class="yg5_tr2">
               ...
               <td>
                ...
                <td>
                    <a href="<?php  echo $this->createWebUrl2('dladdreservation',array('id'=>$item['id']));?>" class="storespan btn btn-xs">
...
<div class="modal fade" id="myModal<?php  echo $item['id'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                      <div class="modal-dialog" role="document">
                        ...
                        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                            <a href="<?php  echo $this->createWebUrl2('dlreservation', array('id'=>$item['id'],'op'=>'delete'));?>" type="button" class="btn btn-info" >确定</a>
                        </div>
                    </div>
                </div>
            </div>
