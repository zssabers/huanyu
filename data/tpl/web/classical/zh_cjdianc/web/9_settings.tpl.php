        ...
        <div class="panel panel-default ygdefault">
            ...
            <div class="panel-body">
              ...
              <!-- <div class="form-group">
                    ...
                    <div class="col-sm-9">
                       <?php  echo tpl_form_field_color('color', '#FF7D5C')?> 
               ...
               <!-- <?php  if($item['qggn']==1) { ?>
                ...
                <!--<div class="form-group duodian">
                  ...
                  <div class="form-group duodian">
                    ...
                    <div class="col-sm-9">
                        <span class="radio-inline">
                            <input id="is_tj1" type="radio" name="is_tj" value="1" <?php  if($item['is_tj']==1) { ?>checked<?php  } ?> />
                            <label for="is_tj1">显示</label>              
                        </span>
                        <span class="radio-inline">
                            <input id="is_tj2" type="radio" name="is_tj" value="2" <?php  if($item['is_tj']==2 || empty($item['is_tj'])) { ?>checked<?php  } ?> /> 
                            <label for="is_tj2">隐藏</label>
                        </span>
                        
                    </div>
                </div>
                <!--<div class="form-group duodian">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">查看商家电话付费 </label>
                    <div class="col-sm-9">
                        <span class="radio-inline">
                            <input id="is_pay1" type="radio" name="is_pay" value="1" <?php  if($item['is_pay']==1) { ?>checked<?php  } ?> />
                            <label for="is_pay1">开启</label>              
                        </span>
                        <span class="radio-inline">
                            <input id="is_pay2" type="radio" name="is_pay" value="2" <?php  if($item['is_pay']==2 || empty($item['is_pay'])) { ?>checked<?php  } ?> /> 
                            <label for="is_pay2">关闭</label>
                        </span>
                ...
                <!--<div class="form-group duodian">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">强制获取手机号 </label>
                    <div class="col-sm-9">
                        <span class="radio-inline">
                            <input id="is_tel1" type="radio" name="is_tel" value="1" <?php  if($item['is_tel']==1) { ?>checked<?php  } ?> />
                            <label for="is_tel1">开启</label>              
                        </span>
                        <span class="radio-inline">
                            <input id="is_tel2" type="radio" name="is_tel" value="2" <?php  if($item['is_tel']==2 || empty($item['is_tel'])) { ?>checked<?php  } ?> /> 
                            <label for="is_tel2">关闭</label>
                        </span>
                        <span class="help-block">*开启后,用户进入平台必须强制获取手机号才能使用</span>
                        
                    </div>
                </div>-->
                <div class="form-group duodian">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">个人中心预约选项 </label>
                    <div class="col-sm-9">
                        <span class="radio-inline">
                            <input id="is_yy1" type="radio" name="is_yy" value="1" <?php  if($item['is_yy']==1) { ?>checked<?php  } ?> />
                            <label for="is_yy1">开启</label>              
                        </span>
                        <span class="radio-inline">
                            <input id="is_yy2" type="radio" name="is_yy" value="2" <?php  if($item['is_yy']==2 || empty($item['is_yy'])) { ?>checked<?php  } ?> /> 
                            <label for="is_yy2">关闭</label>
                        </span>
                        <span class="help-block">*关闭后,小程序端个人中心不显示预约功能</span>
                        
                    </div>
                </div>
                <div class="form-group">

    <label for="inputEmail3" class="col-xs-12 col-sm-3 col-md-2 control-label">价格</label>

    <div class="col-sm-5">
      <div class="input-group">
        <input type="text"  name="pay_money" value="<?php  echo $item['pay_money'];?>" class="form-control" id="inputEmail3" placeholder="请填写金额">
        <span class="input-group-addon">元</span>
      </div>
       <span class="help-block">*开启后设置价格有效</span>
    </div>
             ...
             <!-- <div class="form-group guoshen">
               ...
               <!--  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="mph_name" class="form-control" value="<?php  echo $item['mph_name'];?>" />
                        <div class="help-block">
                        * 请设置前台填写收货地址时门牌号字段名称,为空或删除为默认值
                        </div>
                    </div>
                </div> -->
            </div>
