    ...
    <div class="col-lg-12" style="margin-top: 15px;">
        ...
        <input type="hidden" name="c" value="site" />
            ...
            <div class="input-group" style="width: 300px">
                <input type="text" name="keywords" class="form-control" placeholder="请输入门店名称/订单编号" value="<?php  echo $_GPC['keywords'];?>">
        ...
        <ul class="nav nav-tabs data_tip col-md-4" style="float: left;margin:0">
         <li<?php  if($type2=='yesterday') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('dmorder',array('type2'=>yesterday));?>">昨天</a></li>
            <li<?php  if($type2=='today') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('dmorder',array('type2'=>today));?>">今天</a></li>
            <li<?php  if($type2=='week') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('dmorder',array('type2'=>week));?>">近七天</a></li>
            <li<?php  if($type2=='month') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('dmorder',array('type2'=>month));?>">本月</a></li>
        </ul>          
