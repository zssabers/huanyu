	...
	<div class="form-group djshow" style="display:none">
                    ...
                    <div class="col-sm-9">
                        <label class="radio-inline">
                            <input type="radio" id="emailwye1" name="is_dj" value="1" <?php  if($info['is_dj']==1) { ?>checked<?php  } ?> />
                            <label for="emailwye1">是</label>
                        </label>
                        <label class="radio-inline">
                            <input type="radio" id="emailwye2" name="is_dj" value="0" <?php  if($info['is_dj']==0) { ?>checked<?php  } ?> />
