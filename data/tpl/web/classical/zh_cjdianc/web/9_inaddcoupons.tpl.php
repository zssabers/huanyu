...
<div class="nav_box col-md-1">
    ...
    <!--     <span class="ygxian"></span>
      ...
      <li><a href="<?php  echo $this->createWebUrl('incoupons')?>">优惠券列表</a></li>
      <li class="active"><a href="<?php  echo $this->createWebUrl('inaddcoupons')?>">添加/编辑优惠券</a></li>
    </ul>
</div>
...
<!-- <ul class="nav nav-tabs">
    <span class="ygxian"></span>
    <div class="ygdangq">当前位置:</div>
    <li><a href="<?php  echo $this->createWebUrl('incoupons')?>">优惠券管理</a></li>
    <li class="active"><a href="<?php  echo $this->createWebUrl('inaddcoupons')?>">添加/编辑优惠券</a></li>
</ul> -->
<div class="main">
