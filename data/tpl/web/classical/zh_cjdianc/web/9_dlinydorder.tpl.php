...
<ul class="nav nav-tabs">
  ...
  <li  <?php  if($type=='all') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl2('dlinydorder',array('type'=>all));?>">全部订单</a></li>
  <li   <?php  if($type=='wait') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl2('dlinydorder',array('type'=>wait));?>">待确认</a></li> 
  <li   <?php  if($type=='complete') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl2('dlinydorder',array('type'=>complete));?>">已确认</a></li> 
 <!--  <li   <?php  if($type=='reject') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl2('dlinydorder',array('type'=>reject));?>">已拒绝</a></li>  -->
  <li   <?php  if($type=='cancel') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl2('dlinydorder',array('type'=>cancel));?>">拒绝</a></li> 
            ...
            <div class="panel-body" style="padding: 0px 15px;">
                <div class="row" style="position: relative;">
                    <div class="col-md-12 orderback">
                        ...
                        <a href="<?php  echo $this->createWebUrl('dlinydorder',array('op'=>'dy','order_id'=>$item['id']));?>"><span class="btn btn-xs orderbtn">打印小票</span></a>
                        </div>              
                    ...
                    <div class="col-md-12 orderback2">
                        <div class="ordername">
                            ...
                            <a href="<?php  echo $this->createWebUrl2('dlinydorderinfo',array('id'=>$item['id']));?>"><div class="right btn btn-sm btn-default" style="border:none;">查看详情</div></a>
                        </div>
                        <div class="">
