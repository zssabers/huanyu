...
<ul class="nav nav-tabs">
    ...
    <li <?php  if($_GPC['type']==1) { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl2('dlcomment',array('type'=>1));?>">全部(<?php  echo count($qb)?>)</a></li>
    <li <?php  if($_GPC['type']==2) { ?> class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl2('dlcomment',array('type'=>2));?>">未回复(<?php  echo count($whf)?>)</a></li>
