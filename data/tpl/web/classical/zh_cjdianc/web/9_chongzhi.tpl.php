                       ...
                       <script type="text/javascript">
                         $(function(){
                            $(".shanchu<?php  echo $row['id'];?>").click(function(){          
                                  ...
                                  $.ajax({
                                      type:"post",
                                      url:"<?php  echo $_W['siteroot'];?>/app/index.php?i=<?php  echo $_W['uniacid'];?>&c=entry&do=DelCz&m=zh_cjdianc",
                                      dataType:"text",
                                      data:{id:id},
  ...
  var num = $(".addmyli").length;
    $(function(){
        ...
        $(".tianjia").click(function(){
            num ++;
            var addli = $('<li class="col-md-12 addmyli" id="czli'+num+'" style="padding: 0px;"><div class="col-md-3 chongzhi"><div class="man">满</div><input type="number" name="money" class="money" placeholder="请输入金额"></div><div class="col-md-3 chongzhi"><div class="man">赠送</div><input type="number" name="money2" class="money2" placeholder="请输入金额"><div class="man">元</div></div><div class="col-md-6 chongzhi"><div class="man">充值描述</div><input type="text" name="des" class="money" placeholder="请输入充值描述"><div class="man shanchu" id="shanchu'+num+'"><span class="fa fa-times"></span></div></div></li>');
            addli.appendTo($(".myul"));
        });
        ...
        $("input[name='button']").click(function(){
          ...
          $.ajax({
              type:"post",
              url:"<?php  echo $_W['siteroot'];?>/app/index.php?i=<?php  echo $_W['uniacid'];?>&c=entry&do=AddCz&m=zh_cjdianc",
              dataType:"text",
              data:{list:list},
              success:function(data){
                  // alert(data)
