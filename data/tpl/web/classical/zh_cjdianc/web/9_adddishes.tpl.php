        ...
        <div class="panel panel-default ygdefault">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="number" id="flstock" name="inventory" class="form-control" value="<?php  echo $info['inventory'];?>" onKeyUp="value=value.replace(/[^\d]/g,'')" />
                    </div>
                </div> 
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">无限库存</label>
                    <div class="col-sm-9">
                        <label class="radio-inline">
                            <input type="radio" id="max1" name="is_max" value="1" <?php  if($info['is_max']==1) { ?>checked<?php  } ?> />
                            <label for="max1">开启</label>
                        </label>
                        <label class="radio-inline">
                            <input type="radio" id="max2" name="is_max" value="2" <?php  if($info['is_max']==2 || empty($info['is_max'])) { ?>checked<?php  } ?> />
                            <label for="max2">关闭</label>
                        </label>
                    </div>
                </div>
                <!--<div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="number" id="flxiao" name="sales" class="form-control" value="<?php  echo $info['sales'];?>" onKeyUp="value=value.replace(/[^\d]/g,'')"/>
                    </div>
                </div>-->
                <div class="form-group">
    ...
    $(function(){
      ...
      $.ajax({
        ...
        $("#savebtn").on('click', function(){          
          ...
          var max = $('input[name="is_max"]:checked').val();
