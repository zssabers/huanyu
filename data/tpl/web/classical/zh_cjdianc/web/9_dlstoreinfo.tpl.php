 ...
 <?php  } ?>
	...
	<div class="form-group">
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-9">
                        <p class="input-group">
							<!-- <?php  if($info['coupon_money']>0) { ?>
                             <input type="text" onkeyup="value=value.replace(/[^\d.]/g,'')" name="coupon_money" value="<?php  echo $info['coupon_money'];?>" id="points" class="form-control" disabled/>
							 <?php  } ?> -->
