...
<!--                 <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <label class="radio-inline">
                            <input type="radio" id="paywy1" name="is_open" value="1" <?php  if($item['is_open']==1) { ?>checked<?php  } ?> />
                            <label for="paywy1">开启</label>
                        </label>
                        <label class="radio-inline">
                            <input type="radio" id="paywy2" name="is_open" value="2" <?php  if($item['is_open']==2  || empty($item['is_open'])) { ?>checked<?php  } ?> />
                            <label for="paywy2">关闭</label>
                        </label>    
                        <div class="help-block" style="color: red">
                        * 如选择开启，将启用服务商模式支付，可以给商家设置不同的子商户号进行支付；如关闭服务商支付或者没有设置子商户号的商家将调用平台小程序的默认商户号进行支付
                        </div>
                    </div>
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">服务商商户秘钥：</label>
                    <div class="col-sm-9">
                        <input type="text" name="wxkey" value="<?php  echo $item['wxkey'];?>" id="web_name" class="form-control" />
                        <div class="help-block">
                        * 请输入服务商的32位支付Api密钥，如出现不能支付或支付时提示id为空，则将密钥重置
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">服务商证书apiclient_cert.pem<?php  if($item['apiclient_cert']) { ?><font color="red">(已上传)</font><?php  } ?>：</label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">服务商证书apiclient_key.pem<?php  if($item['apiclient_key']) { ?><font color="red">(已上传)</font><?php  } ?>：</label>
                    <div class="col-sm-9">
                        <p class="form-control-static">
