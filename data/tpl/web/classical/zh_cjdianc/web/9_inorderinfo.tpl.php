...
<div class="main ygmain">
    <div class="panel panel-default">
        <div class="panel-body">
            <a class="btn label-orderinfo" href="<?php  echo $this->createWebUrl('inorder');?>"><i class="fa fa-refresh"></i>返回订单管理</a>
        </div>
    </div>
    <div class="panel panel-default">
        ...
        <div class="panel-body" style="padding: 0px 15px;">
            <div class="row info">
                ...
                <ul class="col-md-9 col-md-push-2 infoul">
                    ...
                    <li class="col-md-3">
                        <div style="color: #44ABF7;">买家付款</div>
                        <div class="progress">
                            <div class="progress-bar progress-bar-yg" role="progressbar" aria-valuenow="60" 
                                aria-valuemin="0" aria-valuemax="100" style="width: 100%;">
                            </div>
                    ...
                    <li class="col-md-3">
                        <div style="color: #44ABF7;">商家发货</div>
                        <div class="progress">
                            <div class="progress-bar progress-bar-yg" role="progressbar" aria-valuenow="60" 
                                aria-valuemin="0" aria-valuemax="100" style="width: 100%;">
                            </div>
    ...
    <div class="panel panel-default">        
        <div class="panel-body" style="padding: 15px 30px;">
            <div class="row">
                ...
                <span class="label label-orderinfo"> 积分支付</span>
                <?php  } else if($item['pay_type']==4) { ?>
                <span class="label label-orderinfo">货到付款</span>
				<?php  } else if($item['pay_type']==5) { ?>
                <span class="label label-orderinfo">储值卡支付</span>
                <?php  } ?>
                <?php  if($item['state']==1) { ?>（<span style="color: #B22222;">未付款</span>）<?php  } ?></p>
                    </div>
                    <div class="info_left_content">
                        <p><span>下单时间：</span><?php  echo $item['time'];?></p>
                        <p><span>收货信息：</span><?php  echo $item['name'];?>--<?php  echo $item['tel'];?>--<?php  echo $item['address'];?></p>
                        <?php  if($item['pay_time']) { ?>
                        <p><span>付款时间：</span><?php  echo $item['pay_time'];?></p>
                        <?php  } ?>
                    </div>                    
                ...
                <div class="col-md-6 info_right">
                    <div class="info_right_top">
                        ...
                        <div class="info_right_type">订单状态：<?php  if($item['state']==1) { ?>
                        <span  style="color:red" >待付款</span>
                        <?php  } else if($item['state']==2) { ?>
                        <span  style="color:orange" >等待接单</span>
                        <?php  } else if($item['state']==3) { ?>
                        <span  style="color:orange" >等待送达</span>
                        <?php  } else if($item['state']==4) { ?>
                        <span  style="color:green" >已完成</span>
                        <?php  } else if($item['state']==5) { ?>
                        <span  style="color:gray" >已评价</span>
                        <?php  } else if($item['state']==6) { ?>
                        <span  style="color:green" >已取消</span>
                        <?php  } else if($item['state']==7) { ?>
                        <span  style="color:orange" >已拒绝</span>
                        <?php  } else if($item['state']==8) { ?>
                        <span  style="color:green" >退款中</span>
                        <?php  } else if($item['state']==9) { ?>
                        <span  style="color:red" >退款成功</span>
                          <?php  } else if($item['state']==10) { ?>
                        <span  style="color:red" >退款拒绝</span>
                        <?php  } ?></div>
                        </div>
                        ...
                        <div class="content1 col-md-12">
                            <div>&nbsp;</div>
                            <div>（货价<?php  echo number_format($item['money']+$item['discount']-$item['box_money']-$item['ps_money'],2)?>+配送费<?php  echo $item['ps_money'];?>+打包费<?php  echo $item['box_money'];?>）</div>
                        </div>
                        <div class="content1 col-md-12">
                            <div>优惠金额：</div>
        ...
        <div class="panel-body" style="padding: 0px 15px;">
            <div class="row">
                <table class="yg5_tabel col-md-12">
                    ...
                    <tr class="yg5_tr3">
                        <td colspan="5">合计：</td>
                        <td colspan="1">¥<?php  echo number_format($item['money']+$item['discount']-$item['ps_money']-$item['box_money'],2)?></td>
                    </tr>
                </table>
            </div>
        </div>
    ...
    <div class="col-md-12">
                    <?php  if($item['state']==2) { ?>
                  <a href="<?php  echo $this->createWebUrl('inorder',array('op'=>'jd','id'=>$item['id']));?>"><button class="btn btn-sm btn-warning">点击接单</button></a>
                  <?php  } ?>
                   <?php  if($item['state']==8) { ?>
                  <a href="<?php  echo $this->createWebUrl('inorder',array('op'=>'refund','id'=>$item['id']));?>"><button class="btn btn-sm btn-info">通过退款</button></a>
                  <a href="<?php  echo $this->createWebUrl('inorder',array('op'=>'reject','id'=>$item['id']));?>"><button class="btn btn-sm btn-warning">拒绝退款</button></a>
                  <?php  } ?>
