...
<style>
	...
	.big-menu .panel .panel-heading .wytitle{height: 50px;padding: 15px 8px 15px 8px;width: 130px;}
...
<div class="header">
    ...
    <ul class="header_right">       
        <li>
        	...
        	<li>
                <a href="index.php?c=miniapp&a=version&do=home&version_id=<?php  echo $_COOKIE['newstr'];?>" class="yyhome">
