...
<ul class="nav nav-tabs">
  ...
  <li  <?php  if($type=='all') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('dispatch',array('type'=>all));?>">全部</a></li>
  <li   <?php  if($type=='jd') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('dispatch',array('type'=>jd,'state'=>1));?>">待接单</a></li>
  <li   <?php  if($type=='qc') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('dispatch',array('type'=>qc,'state'=>2));?>">已接单</a></li>
  <li   <?php  if($type=='sd') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('dispatch',array('type'=>sd,'state'=>3));?>">配送中</a></li>
  <li   <?php  if($type=='wc') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('dispatch',array('type'=>wc,'state'=>4));?>">已完成</a></li>
   <li   <?php  if($type=='qx') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('dispatch',array('type'=>qx,'state'=>5));?>">已取消</a></li>
</ul>
<div class="row ygrow">
  <div class="col-lg-11 nav_head">
    <form action="" method="get" class="col-md-4" style="padding-left: 0">
      ...
      <div class="input-group" style="width: 300px">
        <input type="text" name="keywords" class="form-control" placeholder="请输入骑手名称/手机号/订单ID/运单编号" value="<?php  echo $_GPC['keywords'];?>">
...
<div class="main">
                ...
                <table class="yg5_tabel col-md-12">
                    ...
                    <td><?php  echo $row['id'];?></td>
                     <td><?php  echo $row['order_id'];?></td>
                      ...
                      <td>
                        <span class="storespan btn btn-xs js_detail<?php  echo $row['id'];?>" data-toggle="modal" data-target="#detail">
                        ...
                        <?php  if($row['state']==1) { ?>
                        <span class="storespan btn btn-xs js_zhipai" data-toggle="modal" data-target="#zhipai" data-id="<?php  echo $row['id'];?>">
 ...
 <!--                        <a href="javascript:void(0);" class="storespan btn btn-xs" data-toggle="modal" data-target="#myModal<?php  echo $row['id'];?>">
                            ...
                            <script type="text/javascript">
                              $(function(){
                                  // $(".js_zhipai<?php  echo $row['id'];?>").each(function(){
                                  //   $(this).click(function(){
                                  //       list_id=<?php  echo $row['id'];?>;
                                  //       console.log(list_id)
                                  //       $.ajax({
                                  //           type:"post",
                                  //           url:"https://hl.zhycms.com//app/index.php?i=<?php  echo $_W['uniacid'];?>&c=entry&do=GetRider&m=zh_cjpt",
                                  //           dataType:"json",
                                  ...
                                  // })
                                    ...
                                    $(".js_detail<?php  echo $row['id'];?>").each(function(index){
                                        $(this).click(function(){            
                                            id = <?php  echo $row['id'];?>;
                                            console.log(id)
                                            $.ajax({
                                                type:"post",
                                                url:"<?php  echo $_W['siteroot'];?>app/index.php?i=<?php  echo $_W['uniacid'];?>&c=entry&do=GetOrderInfo&m=zh_cjpt",
                                                dataType:"json",
                                                data:{id:id},
                                                success:function(res){
                                                    console.log(res);
   ...
   var list_id=""
    $(function(){
       ...
       $.ajax({ 
        type: "post",
        dataType: "json",
        url: "<?php  echo $_W['siteroot'];?>/app/index.php?i=<?php  echo $_W['uniacid'];?>&c=entry&do=neworder&m=zh_cjpt",
        ...
        $(".js_zhipai").click(function(){
            ...
            $.ajax({
                type:"post",
                url:"<?php  echo $_W['siteroot'];?>app/index.php?i=<?php  echo $_W['uniacid'];?>&c=entry&do=GetRider&m=zh_cjpt",
                dataType:"json",
                success:function(res){
                    console.log(res)
                    // debugger
        ...
        console.log("列表id"+list_id)
            if(id==""){
                ...
                $.ajax({
                    type:"post",
                    url:"<?php  echo $_W['siteroot'];?>app/index.php?i=<?php  echo $_W['uniacid'];?>&c=entry&do=Receipt&m=zh_cjpt",
                    dataType:"json",
                    data:{
                        id:list_id,
                        qs_id:id
