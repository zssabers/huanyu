            ...
            <div class="row">
                <table class="yg5_tabel col-md-12">
                    ...
                    <tr class="yg5_tr2">
                        ...
                        <td><?php  if($row['type']==1) { ?>注册页面广告位<?php  } else if($row['type']==2) { ?>开屏广告<?php  } else if($row['type']==3) { ?>多店中部广告位<?php  } else if($row['type']==4) { ?>多店底部广告位<?php  } else if($row['type']==5) { ?>门店入驻广告位<?php  } else if($row['type']==6) { ?>积分商城广告位<?php  } else if($row['type']==7) { ?>个人中心广告位<?php  } else if($row['type']==8) { ?>会员中心广告位<?php  } ?></td>
