...
<style>
	...
	.fa-space-shuttle,.fa-money,.fa-pencil-square-o,.fa-comments,.fa-star-half-o,.fa-users,.fa-user,.fa-clipboard,.fa-money,.fa-life-ring,.fa-bars,.fa-recycle,.fa-cog,.fa-book,.fa-database,.fa-gift,.fa-user,.fa-binoculars,.fa-trophy,.fa-key{margin-right: 15px;}
...
<?php  $res=pdo_get('cjpt_system',array('uniacid'=>$_W['uniacid']))?>
<div class="header">
	<div class="wheaderbox">
		<img class="header_logo" src="<?php  if($res['logo']) { ?><?php  echo tomedia($res['logo'])?><?php  } else { ?>../addons/zh_cjpt/template/images/htlogo.png<?php  } ?>" alt=""/>
		<span class="header_title">
			<?php  if($res['url_name']) { ?><?php  echo $res['url_name'];?>
			<?php  } else { ?>后台管理系统<?php  } ?>
		</span>
	</div>
    <div class="header_left">        
        <?php  if($_W['role'] == 'founder') { ?>
        <a href="<?php  echo $this->createWebUrl('index')?>"><div class="header_btn">返回首页</div></a>
         <?php  } ?>  
    </div>
    <ul class="header_right">       
        <li>
			...
			<?php  if($_W['role'] == 'founder') { ?>
        	<li>
        	  <a href="index.php?c=miniapp&a=version&do=home&version_id=<?php  echo $_GPC['version_id'];?>" class="yyhome">
