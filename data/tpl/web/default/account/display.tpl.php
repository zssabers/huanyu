...
<div class="panel panel-cut" id="js-account-display" ng-controller="AccountDisplay" ng-cloak>
	...
	<div class="panel-heading mixMenu-panel-heading">
		<ul class="navbar-nav">
			<li  class="on-tab" >
				<a href="./index.php?c=account&a=display&type=all&title=%E5%85%A8%E9%83%A8" >全部</a>
			</li>
			<!--
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="input-group">
									<input type="text" class="form-control" name="keyword" value="<?php  echo $_GPC['keyword'];?>" placeholder="请输入名称">
