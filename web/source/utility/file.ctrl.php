...
if ($do == 'delete') {
	...
	$table->searchWithUniacidOrUid($uniacid, $_COOKIE['53d5___uid']);
...
if ($do == 'image') {
	...
	$attachment_table->searchWithUniacid($uniacid,$_COOKIE['storeid']);
...
if ($do == 'group_list') {
	...
	$query->searchWithUniacidOrUid($uniacid, $_COOKIE['53d5___uid']);
	$list = $query->getall();
	iajax(0, $list);
}
