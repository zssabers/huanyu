...
!function ($, moment) {
	...
	$.fn.daterangepickers = function (options, cb) {
		this.each(function () {
			var el = $(this);
			...
			if(typeof(options) == 'object') {
				if(typeof(options.ranges) != 'object') {
					...
					options.ranges['一周后'] = [moment(),moment().add('days', 6)];
					options.ranges['二周后'] = [moment(),moment().add('days', 13)];
					options.ranges['一月后'] = [moment(),moment().add('days', 29)];
